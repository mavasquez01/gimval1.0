        ...
        <div class="container">
            ...
            <div class="d-flex justify-content-center gap-3 gap-md-4 mt-3 flex-wrap">
                <a href="https://www.instagram.com/valkiriacenter?igsh=MWIwc3hpbHR4MnMweA==" class="text-decoration-none">
                    <img src="<?= base_url('/assets/images/ig.png') ?>" class="social-icon" alt="Instagram">
                </a>
                <a href="#" class="text-decoration-none">
                    <img src="<?= base_url('/assets/images/fb.png') ?>" class="social-icon" alt="Facebook">
                </a>
                <a href="#" class="text-decoration-none">
                    <img src="<?= base_url('/assets/images/tk.png') ?>" class="social-icon" alt="TikTok">
                </a>
                <a href="https://wa.me/56962314079" class="text-decoration-none">
                    <img src="<?= base_url('/assets/images/wsp.png') ?>" class="social-icon" alt="WhatsApp">
                </a>
            </div>
