                ...
                <div class="container-fluid px-4" style="max-width: 420px;">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <ul class="nav nav-tabs border-0 justify-content-between" id="dias-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <button class="nav-link" id="martes-tab" data-bs-toggle="tab"
                                    data-bs-target="#martes-pane" type="button">
                                    <small>M</small><br>13
                                </button>
                            </li>
                            ...
                            <li class="nav-item">
                                <button class="nav-link" id="jueves-tab" data-bs-toggle="tab"
                                    data-bs-target="#jueves-pane" type="button">
                                    <small>J</small><br>15
                                </button>
                            </li>
                            ...
                            <li class="nav-item">
                                <button class="nav-link" id="sabado-tab" data-bs-toggle="tab"
                                    data-bs-target="#sabado-pane" type="button">
                                    <small>S</small><br>17
                                </button>
                            </li>
