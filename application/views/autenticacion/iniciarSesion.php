                ...
                <div class="card bg-dark text-white" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        ...
                        <div class="mb-md-5 mt-md-4 pb-5">
                            ...
                            <?php
                            $alertaLogin = $this->session->flashdata('alerta_login');
                            ?>

                            <div id="mensajeLogin"
                                data-icon="<?= isset($alertaLogin['icon']) ? html_escape($alertaLogin['icon']) : '' ?>"
                                data-title="<?= isset($alertaLogin['title']) ? html_escape($alertaLogin['title']) : '' ?>"
                                data-text="<?= isset($alertaLogin['text']) ? html_escape($alertaLogin['text']) : '' ?>">
                            </div>
                            <form id="formularioInicioSesion" action="<?= site_url('autenticacion/iniciarSesion') ?>"
                                method="POST">
                                ...
                                <div data-mdb-input-init class="form-outline form-white mb-4">
                                    ...
                                    <input type="email" id="correo" name="correo" class="form-control form-control-lg"
                                        data-bs-theme="dark" placeholder="Ej: usuario@gmail.com">
                                </div>
                                <div data-mdb-input-init class="form-outline form-white mb-4">
                        ...
                        <div>
                            <p class="mb-0">¿No tienes cuenta? <a href="#!" class="text-white-50 fw-bold">Contactar al
                                    gimnasio</a>
                            </p>
                        </div>
